...
namespace LLDB
{
    ...
    public unsafe partial class TypeMemberFunction : IDisposable
    {
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetReturnType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        public LLDB.Type GetArgumentTypeAtIndex(uint _0)
        {
            var arg0 = _0;
            var __ret = new LLDB.Type.Internal();
            Internal.GetArgumentTypeAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.Type.__CreateInstance(__ret);
        }
    ...
    public unsafe partial class Type : IDisposable
    {
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetPointerType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetPointeeType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetReferenceType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetTypedefedType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetDereferencedType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetUnqualifiedType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetArrayElementType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetVectorElementType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetCanonicalType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        public LLDB.Type GetBasicType(LLDB.BasicType type)
        {
            var arg0 = type;
            var __ret = new LLDB.Type.Internal();
            Internal.GetBasicType_1(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        public LLDB.TypeMember GetFieldAtIndex(uint idx)
        {
            ...
            Internal.GetFieldAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
        ...
        public LLDB.TypeMember GetDirectBaseClassAtIndex(uint idx)
        {
            var arg0 = idx;
            var __ret = new LLDB.TypeMember.Internal();
            Internal.GetDirectBaseClassAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.TypeMember.__CreateInstance(__ret);
        }
        ...
        public LLDB.TypeMember GetVirtualBaseClassAtIndex(uint idx)
        {
            var arg0 = idx;
            var __ret = new LLDB.TypeMember.Internal();
            Internal.GetVirtualBaseClassAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.TypeMember.__CreateInstance(__ret);
        }
        ...
        public LLDB.Type GetTemplateArgumentType(uint idx)
        {
            var arg0 = idx;
            var __ret = new LLDB.Type.Internal();
            Internal.GetTemplateArgumentType_0(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Type.Internal();
            Internal.GetFunctionReturnType_0(__Instance, new IntPtr(&__ret));
            return LLDB.Type.__CreateInstance(__ret);
        }
        ...
        public LLDB.TypeList GetFunctionArgumentTypes()
        {
            ...
            Internal.GetFunctionArgumentTypes_0(__Instance, new IntPtr(&__ret));
        ...
        public LLDB.TypeMemberFunction GetMemberFunctionAtIndex(uint idx)
        {
            ...
            Internal.GetMemberFunctionAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
    ...
    public unsafe partial class TypeList : IDisposable
    {
        ...
        public LLDB.Type GetTypeAtIndex(uint index)
        {
            var arg0 = index;
            var __ret = new LLDB.Type.Internal();
            Internal.GetTypeAtIndex_0(__Instance, new IntPtr(&__ret), arg0);
            return LLDB.Type.__CreateInstance(__ret);
        }
