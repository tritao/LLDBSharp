...
namespace LLDB
{
    ...
    public enum InputReaderGranularity
    {
        Invalid = 0,
        Byte = 1,
        Word = 2,
    ...
    /// <para>The enum -&gt; string code is in Language.cpp, don't change this</para>
    ...
    public enum InstrumentationRuntimeType
    {
        AddressSanitizer = 0,
        ThreadSanitizer = 1,
        ypes = 2
    ...
    public enum ExpressionEvaluationPhase
    {
        Parse = 0,
        IRGen = 1,
        Execution = 2,
    ...
    public enum MemberFunctionKind
    {
        Unknown = 0,
        Constructor = 1,
        Destructor = 2,
    ...
    public enum TypeSummaryCapping
    {
        Capped = 1,
        Uncapped = 0
    }
