...
namespace LLDB
{
    ...
    public unsafe partial class Platform : IDisposable
    {
        ...
        public partial struct Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity]
            [DllImport("lldb", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.ThisCall,
                EntryPoint="?GetUnixSignals@SBPlatform@lldb@@QBE?AVSBUnixSignals@2@XZ")]
        ...
        public LLDB.Error ConnectRemote(LLDB.PlatformConnectOptions connect_options)
        {
            ...
            Internal.ConnectRemote_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0);
        ...
        public LLDB.Error Put(LLDB.FileSpec src, LLDB.FileSpec dst)
        {
            ...
            var __ret = new LLDB.Error.Internal();
            Internal.Put_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, arg1);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error Get(LLDB.FileSpec src, LLDB.FileSpec dst)
        {
            ...
            var arg1 = dst.__Instance;
            var __ret = new LLDB.Error.Internal();
            Internal.Get_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, arg1);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error Install(LLDB.FileSpec src, LLDB.FileSpec dst)
        {
            ...
            var arg1 = dst.__Instance;
            var __ret = new LLDB.Error.Internal();
            Internal.Install_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, arg1);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error Run(LLDB.PlatformShellCommand shell_command)
        {
            ...
            var __ret = new LLDB.Error.Internal();
            Internal.Run_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error Launch(LLDB.LaunchInfo launch_info)
        {
            ...
            var __ret = new LLDB.Error.Internal();
            Internal.Launch_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Error.Internal();
            Internal.Kill_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), pid);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error MakeDirectory(string path, uint file_permissions)
        {
            var arg0 = Marshal.StringToHGlobalAnsi(path);
            var __ret = new LLDB.Error.Internal();
            Internal.MakeDirectory_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, file_permissions);
            Marshal.FreeHGlobal(arg0);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error SetFilePermissions(string path, uint file_permissions)
        {
            var arg0 = Marshal.StringToHGlobalAnsi(path);
            var __ret = new LLDB.Error.Internal();
            Internal.SetFilePermissions_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, file_permissions);
            Marshal.FreeHGlobal(arg0);
            return LLDB.Error.__CreateInstance(__ret);
        }
