...
namespace LLDB
{
    public unsafe partial class Thread : IDisposable
    {
        ...
        public partial struct Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity]
            [DllImport("lldb", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.ThisCall,
                EntryPoint="?GetStopReasonExtendedBacktraces@SBThread@lldb@@QAE?AVSBThreadCollection@2@W4InstrumentationRuntimeType@2@@Z")]
            internal static extern void GetStopReasonExtendedBacktraces_0(global::System.IntPtr instance, global::System.IntPtr @return, LLDB.InstrumentationRuntimeType type);
            ...
            [SuppressUnmanagedCodeSecurity]
            [DllImport("lldb", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.ThisCall,
                EntryPoint="?StepInto@SBThread@lldb@@QAEXPBDIAAVSBError@2@W4RunMode@2@@Z")]
        ...
        public LLDB.Queue GetQueue()
        {
            ...
            Internal.GetQueue_0((__Instance + __PointerAdjustment), new IntPtr(&__ret));
        ...
        public LLDB.ThreadCollection GetStopReasonExtendedBacktraces(LLDB.InstrumentationRuntimeType type)
        {
            ...
            Internal.GetStopReasonExtendedBacktraces_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0);
        ...
        public LLDB.Value GetStopReturnValue()
        {
            ...
            Internal.GetStopReturnValue_0((__Instance + __PointerAdjustment), new IntPtr(&__ret));
        ...
        public LLDB.Error StepOverUntil(LLDB.Frame frame, LLDB.FileSpec file_spec, uint line)
        {
            ...
            Internal.StepOverUntil_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, arg1, line);
        ...
        public LLDB.Error StepUsingScriptedThreadPlan(string script_class_name)
        {
            ...
            var __ret = new LLDB.Error.Internal();
            Internal.StepUsingScriptedThreadPlan_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0);
            Marshal.FreeHGlobal(arg0);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Error ReturnFromFrame(LLDB.Frame frame, LLDB.Value return_value)
        {
            ...
            var __ret = new LLDB.Error.Internal();
            Internal.ReturnFromFrame_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), arg0, arg1);
            return LLDB.Error.__CreateInstance(__ret);
        }
        ...
        public LLDB.Frame GetFrameAtIndex(uint idx)
        {
            ...
            Internal.GetFrameAtIndex_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), idx);
        ...
        {
            var __ret = new LLDB.Frame.Internal();
            Internal.GetSelectedFrame_0((__Instance + __PointerAdjustment), new IntPtr(&__ret));
            return LLDB.Frame.__CreateInstance(__ret);
        }
        ...
        {
            var __ret = new LLDB.Frame.Internal();
            Internal.SetSelectedFrame_0((__Instance + __PointerAdjustment), new IntPtr(&__ret), frame_idx);
            return LLDB.Frame.__CreateInstance(__ret);
        }
